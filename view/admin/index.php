                ...
                <div class="font-[sans-serif] text-[#333]">
                    <div class="grid lg:grid-cols-4 sm:grid-cols-2 gap-x-6 gap-y-12 divide-x divide-gray-300">
                        <div class="text-center">
                            ...
                            <h3 class="text-3xl font-extrabold text-blue-600 mt-5"><?php echo $total_user?></h3>
                            <p class="font-semibold mt-3">Total user</p>
                        </div>
                        <div class="text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-600 w-10 inline-block" viewBox="0 0 512 512">
                            ...
                            <h3 class="text-3xl font-extrabold text-blue-600 mt-5"><?php echo $total_lab ?></h3>
                            <p class="font-semibold mt-3">Total Lab</p>
                        </div>
                        <div class="text-center">
                            ...
                            <h3 class="text-3xl font-extrabold text-blue-600 mt-5"><?php echo $total_laboran ?></h3>
                            <p class="font-semibold mt-3">Total laboran</p>
                        </div>
                        <div class="text-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-600 w-10 inline-block" viewBox="0 0 512 512">
                            ...
                            <h3 class="text-3xl font-extrabold text-blue-600 mt-5"><?php echo $lab_empty ?></h3>
                            <p class="font-semibold mt-3">Total lab kosong</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full bg-white">
                            ...
                            <tbody class="text-gray-700">
                                <?php foreach ($user as $users): {
                                    ...
                                    <tr>
                                        <td class="w-1/3 text-left py-3 px-4"><?php echo $users['username'] ?></td>
                                        <td class="w-1/3 text-left py-3 px-4"><?php echo $users['nim'] ?></td>
                                        <td class="text-left py-3 px-4"><?php echo $users['role'] ?></td>
