...
<body class="font-sans bg-gray-100">
    ...
    <div class="flex flex-wrap items-center gap-5 w-full justify-between">
        <p class="text-xl font-bold font-sens-sarif text-white text-[40px]">Informasi Lab Teknik Informatika</p>
        ...
        <div class="flex items-center gap-5">
            ...
            <div class="flex items-center bg-gray-100 px-6 py-3 rounded">
                <input type="text" placeholder="Search..." class="w-full text-sm bg-transparent outline-none pr-2" />
