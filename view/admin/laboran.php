    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <h1 class="text-3xl text-black pb-6">Laboran</h1>
                <!-- Modal toggle -->
                ...
                <div id="defaultModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                        ...
                        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                            ...
                            <!-- Modal body -->
                            <form action="index.php?action=registerLaboran" method="post">
                                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        <label for="pw" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">passwrod</label>
                                        <input type="number" name="password" id="pw" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="passsword" required="">
                                    </div>
                                    <div>
                                        <label for="pw2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">konfirmasi passwrod</label>
                                        <input type="number" name="repeat_password" id="pw2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="konfirmasi password" required="">
                                    </div>
                                    <!-- <div>
                                    ...
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-3">
                                                ...
                                                <?php echo $laborans['username']; ?>
                                                </p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap"><?php echo $laborans ['role']; ?></p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <p class="text-gray-900 whitespace-no-wrap">
                                            <?php echo $laborans['nim'] ?>
                                        </p>
                                    </td>
                                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                        <span
