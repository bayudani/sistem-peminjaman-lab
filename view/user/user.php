...
>>>>>>> 6f6e1f9bf02b2a207203cb7a373ae4ef44e20c6b
    ...
    <section class="cover bg-blue-teal-gradient relative bg-blue-600 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 overflow-hidden py-48 flex items-center min-h-screen">
        ...
        <!-- Content -->
        <div class="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
>>>>>>> 0a9f27ff3587bbf888c4c83697e84a94e575155a
            <div>
                <h1 class="text-white text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">A better life
                    starts with a beautiful smile.</h1>
                <p class="text-blue-100 text-xl md:text-2xl leading-snug mt-4">Welcome to the Dentist Office of
                    Dr. Thomas Dooley, where trust and comfort are priorities.</p>
                <a href="#"
                    class="px-8 py-4 bg-teal-500 text-white rounded inline-block mt-8 font-semibold">Book
                    Appointment</a>
            </div>
<<<<<<< HEAD
...
=======
        ...
        <section class="relative px-4 py-16 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-32">
            ...
            <div class="flex flex-col lg:flex-row lg:-mx-8">
                ...
                <img src="src/images/lab.jpeg" alt="" class="h-23 mx-auto">
                    <h2 class="text-3xl leading-tight font-bold mt-4">Welcome to the Dentist Office of Dr. Thomas Dooley
                    </h2>
            ...
            <div class="md:flex md:flex-wrap mt-24 text-center md:-mx-4">
                <div class="md:w-1/2 md:px-4 lg:w-1/4">
                    <div class="bg-white rounded-lg border border-gray-300 p-8">
                    <img src="src/images/lab.jpeg" alt="" class="h-20 mx-auto">
                ...
                <div class="md:w-1/2 md:px-4 mt-4 md:mt-8 lg:mt-0 lg:w-1/4">
                    <div class="bg-white rounded-lg border border-gray-300 p-8">
                    <img src="src/img/lab.jpeg" alt="" class="h-20 mx-auto">
