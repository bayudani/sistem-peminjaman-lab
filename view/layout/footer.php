...
<footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                    <h5 class="uppercase tracking-wider font-semibold text-gray-500">Teknik Informatika</h5>
                    <ul class="mt-4">
                        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Teknik Informatika</a>
                        </li>
                        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Rekayasa Perangkat
                                Lunak</a></li>
                        <li class="mt-2"><a href="#" title="" class="opacity-75 hover:opacity-100">Keamanan Sistem Informasi</a></li>
                    </ul>
                </div>
                    ...
                    <ul class="mt-4">
                        <li>
                            <a href="#" title="" class="block flex items-center opacity-75 hover:opacity-100">
                                ...
                                <span class="ml-3">
                                Jl. Bathin Alam, Bengkalis Riau - 28711
                                </span>
                            </a>
                        </li>
                        <!-- <li class="mt-4">
                ...
                <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                    ...
                    <p class="text-sm text-gray-400 mt-12">© 2024 ProDentists. <br class="hidden lg:block">All Rights
                        Reserved.
                    </p>
                </div>
            </div>
